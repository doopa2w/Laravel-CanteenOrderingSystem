        ...
        <div class = "row">
            ...
            <div class ="col-md-3 mb-md-0 mb-3">
                ...
                <ul class = "list-unstyled">
                    <li>
                        <a href = "{{ url('/foods') }}" style="color: white;">Foods</a>
                    </li>
                    <li>
                        <a href = "{{ url('/orders') }}" style="color: white;">Orders</a>
                    </li>   
                    <li>
                        <a href = "{{ url('/posts') }}" style="color: white;">News</a>
                    </li>
                    <a>
            ...
            <div class ="col-md-3 mb-md-0 mb-3">
                ...
                <ul class = "list-unstyled">
                    <li>
                        <a href = "{{ url('/manager') }}" style="color: white;">Manager</a>
                    </li>
                    <li>
                        <a href = "{{ url('/staff') }}" style="color: white;">Staff</a>
                    </li>           
                </ul>               
            </div>
        </div>
